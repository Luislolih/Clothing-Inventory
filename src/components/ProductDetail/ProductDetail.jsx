...
const ProductDetail = ({ className }) => {
    ...
    return (
        <div className={className}>
            ...
            <div className=" z-0 overflow-scroll flex flex-col h-full items-center bg-white  text-md justify-center w-full lg:w-1/2 gap-3 px-16 py-8 h-auto rounded-lg shadow-md shadow-black">
